...
#=======================================================================================
# DEFINISI DAN SPESIFIKASI
# JumlahBinary : 2 List : integer 0, 1 --> list : integer
#    {JumlahBinary (L1, L1) adalah fungsi menjumlahkan 2 buah biner dalam bentuk list dan mnegeluarkan sebuah list biner pula}
# def JumlahBinary (L1, L2) :
#     return biner(jumlahInteger(L1, L2))
...
def addList (L1, L2) :
    if isEmpty(L1) :
        ...
        return konsi(addList(head(L1),head(L2)),lastElmt(L1)+lastElmt(L2))
...
def JumlahBinary (L1,L2) :
    return addOne(delZero(addList(L1, L2)), 0)


print(JumlahBinary([1,1,0],[1,1]))
