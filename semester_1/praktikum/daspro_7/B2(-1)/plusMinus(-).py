...
#=======================================================================================
def isganjil (L) :
    return nbElemen(L) %2 == 1

def isgenap (L) :
    return nbElemen(L) %2 == 0

def messup (L) :
    if isEmpty(L) :
        return []
    elif isganjil(L) :
        return konkat(firstElmt(L), (firstElmt(tail(L)))*(-1))
    elif isgenap(L) :
        return konkat((-firstElmt(L))*(-1), (firstElmt(tail(L))))
    
print(messup([1, 2, 3, 4, 5]))
print(messup([1, 2, 3, 4, 5, 6]))
