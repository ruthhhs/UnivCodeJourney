...
#=======================================================================================
# DEFINISI DAN SPESIFIKASI
# PulauAngka : 2 List : integer --> List : integer
#    {PulauAngka (D, M) adalah fungsi untuk mengeluarkan elemen di M dari D}
def PulauAngka (D, M) :
    if isEmpty(D) :
        return []
    elif isEmpty(M) :
...
print(PulauAngka([1, 3, 4, 6, 2, 7, 8, 4, 3], [3, 4]))
