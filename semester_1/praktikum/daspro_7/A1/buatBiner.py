...
# DEFINISI DAN SPESIFIKASI
# mainBiner : 2 integer > 0 --> list : integer
#    {mainBiner (a, b) adlah fungsi untuk mengubah bilangan bulat a menjadi biner dengan panjang bit b}
...
def mainBiner (a, b) :
    if b > nbElemen(biner(a)) :
        return konkat([0]*(b-nbElemen(biner(a))), biner(a))
    else :
        return biner(a)[-b:]
