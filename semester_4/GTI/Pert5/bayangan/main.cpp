...
// ======================================================
// Fungsi membuat proyeksi bayangan
// ======================================================
void glShadowProjection(float *l, float *e, float *n)
{
    ...
    // Kalikan matriks bayangan ke objek
    glMultMatrixf(mat);
}
...
void help()
{
    printf("Contoh proyeksi bayangan objek OpenGL\n");
}
