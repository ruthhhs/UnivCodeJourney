...
float posXBadan = 10, posXKotak = 0;
float posYBadan = 7, posYKotak = 6;

float rotTangan1 = 0.0f;
float rotTangan2 = 0.0f;
float rotTangan3 = 0.0f;
float rotTangan4 = 0.0f;

int kick = 0, roll = 0, hit = 0;
int gerakTangan = 0, drop = 0;
int bring = 0, grab = 0, tabrak = 0;
...
void keyboard(unsigned char key, int x, int y)
{
    switch (key)
    {
        ...
        case 32:
            ...
            rotTangan1 = rotTangan2 = rotTangan3 =
            rotTangan4 = kick = roll = gerakTangan =
            drop = hit = bring = grab = 0;
